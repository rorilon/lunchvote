                ...
                <MainDiv>
                    <ParticipantsDiv>
                        <ParticipantInput
                            ...
                            onChange={event =>
                                value.changeParticipantName(props.index, event.target.value)
                            }
                        ></ParticipantInput>
                    </ParticipantsDiv>
                    {[0, 1, 2].map(i => (
                        <RestaurantDiv
                            onClick={event =>
                                value.setVenueChoiceForParticipant(props.index, i)
                            }
                            highlighted={
                                i === value.getVenueChoiceForParticipant(props.index)
                            }
                        />
                    ))}
                </MainDiv>
